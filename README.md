...
[![Java CI](https://github.com/hazendaz/jmockit1/actions/workflows/ci.yaml/badge.svg)](https://github.com/hazendaz/jmockit1/actions/workflows/ci.yaml)
...
[![Maven Central](https://img.shields.io/maven-central/v/com.github.hazendaz.jmockit/jmockit.svg)](https://central.sonatype.com/artifact/com.github.hazendaz.jmockit/jmockit)
...
* use JDK 21 or newer
* use Maven 3.9.16 or newer; the following are the top-level modules:
    1. main/pom.xml: builds jmockit-2.n.jar, running JUnit 3|4|5|6 and TestNG test suites
    2. coverageTests/pom.xml: runs JUnit 6 tests for the coverage tool
    3. samples/pom.xml: various sample test suites (tutorial, LoginService, java8testing) using JUnit 6 or TestNG 7
