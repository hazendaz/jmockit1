 ...
 * <code>visitMethod</code>)* <code>visitEnd</code>.
 */
public class ClassVisitor extends BaseWriter {
     ...
     * @param outerName
     *            the internal name of the class to which the inner class belongs; <code>null</code> for not member
     *            classes
     * @param innerName
     *            the (simple) name of the inner class inside its enclosing class; <code>null</code> for anonymous inner
     *            classes
     * @param access
     ...
     * @param signature
     *            the field's signature; <code>null</code> when the field's type does not use generic types
     * @param value
     *            the field's initial value; <code>null</code> when the field does not have an initial value; otherwise,
     *            must be an {@link Integer}, a {@link Float}, a {@link Long}, a {@link Double} or a {@link String} (for
     *            <code>int</code>, <code>float</code>, <code>long</code> or <code>String</code> fields respectively);
     *            <em>this parameter is only used for static fields</em>; its value is ignored for non static fields,
     *            which must be initialized through bytecode instructions in constructors or methods
     *
     * @return a visitor to visit field annotations and attributes, or <code>null</code> if this class visitor is not
     ...
     * <code>null</code>) each time it is called, i.e., it should not return a previously returned visitor.
     *
     * @param access
     ...
     * @param signature
     *            the method's signature, <code>null</code> if the method parameters, return type and exceptions do not
     *            use generic types
     * @param exceptions
     *            the internal names of the method's exception classes
     *
     * @return an object to visit the byte code of the method, or <code>null</code> if this class visitor is not
