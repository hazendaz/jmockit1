...
/**
 * Constants for <a href="https://docs.oracle.com/javase/specs/jvms/se12/html/jvms-4.html#jvms-4.4-140">types of
 * items</a> in the constant pool of a class.
 */
public interface ConstantPoolTypes {
    ...
    /**
     * The base value for all CONSTANT_MethodHandle constant pool items. Internally, there are 9 variations of
     * CONSTANT_MethodHandle items, which are stored into 9 different items, of types 21 to 29.
     */
    int HANDLE_BASE = 20;
