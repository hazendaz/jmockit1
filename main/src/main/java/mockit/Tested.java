...
public @interface Tested {
     ...
     * <li>{@link javax.inject.Provider Provider&lt;T>}: a javax provider which produces an instance of type
     * <code>T</code> is injected.</li>
     * <li>{@link jakarta.inject.Provider Provider&lt;T>}: a jakarta provider which produces an instance of type
     * <code>T</code> is injected.</li>
     ...
     * <li>{@link javax.enterprise.context.Conversation}: an javax object that emulates a web application's conversation
     * context is created.</li>
     * <li>{@link jakarta.enterprise.context.Conversation}: an jakarta object that emulates a web application's
