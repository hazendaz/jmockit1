...
public final class DefaultValues {
    ...
    static {
        ...
        TYPE_DESC_TO_VALUE_MAP.put("Ljava/lang/Iterable;", List.of());
        TYPE_DESC_TO_VALUE_MAP.put("Ljava/util/Enumeration;", enumeration(List.of()));
        TYPE_DESC_TO_VALUE_MAP.put("Ljava/util/Collection;", List.of());
        TYPE_DESC_TO_VALUE_MAP.put("Ljava/util/List;", List.of());
        TYPE_DESC_TO_VALUE_MAP.put("Ljava/util/Set;", Set.of());
        TYPE_DESC_TO_VALUE_MAP.put("Ljava/util/SortedSet;", unmodifiableSortedSet(new TreeSet<>()));
        TYPE_DESC_TO_VALUE_MAP.put("Ljava/util/Map;", Map.of());
        ...
        TYPE_DESC_TO_VALUE_MAP.put("Ljava/util/ListIterator;", List.of().listIterator());
