...
public final class FieldReflection
{
    ...
    @Nonnull
    public static Field setField(@Nonnull Class<?> theClass, @Nullable Object targetObject, @Nullable String fieldName,
    ...
    @Nonnull
    private static Field getDeclaredField(@Nonnull Class<?> theClass, @Nonnull String fieldName,
    ...
    private static String errorMessageForMoreThanOneFieldFound(@Nonnull Type desiredFieldType, boolean instanceField,
                                                               boolean forAssignment, @Nonnull Field firstField,
                                                               @Nonnull Field secondField) {
